...
class ExpertDocumentsServiceCreateTests : ExpertDocumentsServiceMocks() {
    ...
    inner class CreateTests {
        ...
        fun `Should throw BadRequestException when user exist but it's role not EXPERT`() {
            ...
            assertThat(exception.message).isEqualTo("У этого пользователя есть роль ${user.role}, а не ${UsersRoles.EXPERT}. Пожалуйста, используйте другой контроллер для создания его документов.")
